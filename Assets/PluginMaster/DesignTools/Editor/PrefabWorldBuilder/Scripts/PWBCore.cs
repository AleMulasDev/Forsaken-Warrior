...
namespace PluginMaster
{
    ...
    public class PWBKeyCombinationUSM : PWBKeyCombination
    {
        ...
        public override KeyCode keyCode => UnityEditor.ShortcutManagement.ShortcutManager.instance
            .GetShortcutBinding(_shortcutId).keyCombinationSequence.First().keyCode;
