...
namespace PluginMaster
{
    ...
    public static partial class PWBIO
    {
        ...
        public static void ResetPinValues()
        {
            ...
            var pointRotation = Quaternion.Inverse(Quaternion.Euler(strokeItem.additionalAngle));
            ...
            for (int x = -1; x <= 1; x += 2)
            {
                for (int z = -1; z <= 1; z += 2)
                {
                    ...
                    var point = pointRotation * Vector3.Scale(boxPoint, halfSize) + centerToPivotOnPlane;
            ...
            for (int y = -1; y <= 1; y += 2)
            {
                ...
                _pinBoundPoints.Add(new System.Collections.Generic.List<Vector3>());
                _initialPinBoundPoints.Add(new System.Collections.Generic.List<Vector3>());
                var center = pointRotation * new Vector3(0f, -y * halfSize.y, 0f) + centerToPivot;
